...
public class BookingController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Booking> updateBooking(@PathVariable Long id, @RequestBody Booking bookingDetails) throws ServiceNotFoundException {
//        try {
...
//        }
    ...
    public ResponseEntity<?> updateUserDiscount(@PathVariable Long userId, @RequestParam double discount) throws ServiceNotFoundException {
//        try {
